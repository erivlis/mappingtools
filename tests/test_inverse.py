...
class TestInverse:
    ...
    def test_invert_unique_sets(self):
        # Arrange
        mapping = {'a': {1}, 'b': {2}, 'c': {3}}
    ...
    def test_invert_single_element_sets(self):
        # Arrange
        mapping = {'a': {1}, 'b': {2}}
    ...
    def test_invert_non_string_keys_values(self):
        # Arrange
        mapping = {1: {2}, 3: {4}}
    ...
    def test_invert_empty_sets(self):
        # Arrange
        mapping = {'a': set(), 'b': set()}
    ...
    def test_invert_nested_sets(self):
        # Arrange
    ...
    def test_invert_mixed_data_types(self):
        # Arrange
        mapping = {'a': {1, 'x'}, 'b': {2, 'y'}}
    ...
    def test_invert_duplicate_values_across_sets(self):
        # Arrange
        mapping = {'a': {1, 2}, 'b': {2, 3}}
    ...
    def test_invert_large_mappings(self):
        # Arrange
        max_i = 1000
        max_j = 100
    ...
    def test_invert_order_consistency(self):
        # Arrange
        mapping = {'a': {1, 2}, 'b': {3, 4}}
    ...
    def test_invert_complex_nested_structures(self):
        # Arrange
        mapping = {
