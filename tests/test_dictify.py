...
def test_dictify_with_key_conversion():
    # Arrange
    obj = {'a': 1, 'b': 2}
...
def test_dictify_list_of_dicts():
    # Arrange
    obj = [{'a': 1}, {'b': 2}]
    expected = [{'a': 1}, {'b': 2}]
...
def test_dictify_dataclass_instance():
    # Arrange
...
def test_dictify_nested_structure():
    # Arrange
    obj = {'a': [1, {'b': 2}], 'c': {'d': 3}}
...
def test_dictify_object_with_dict_attribute():
    # Arrange
    class Person:
...
def test_dictify_empty_structures():
    # Arrange
    obj = {}
    expected = {}
...
def test_dictify_non_standard_attributes():
    # Arrange
    class CustomObject:
        def __init__(self):
...
def test_dictify_deeply_nested_structures():
    # Arrange
    obj = {'a': [{'b': [{'c': 1}]}]}
    expected = {'a': [{'b': [{'c': 1}]}]}
...
# def test_dictify_circular_references():
#     # Arrange
#     obj = {}
#     obj['self'] = obj
#
...
def test_dictify_custom_key_conversion_function():
    # Arrange
    obj = {'a': 1, 'b': 2}
...
def test_dictify_mixed_types_within_lists():
    # Arrange
    obj = [1, "string", {'a': 2}]
